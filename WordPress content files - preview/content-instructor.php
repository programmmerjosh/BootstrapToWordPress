<?php
// Instructor Section Advanced Custom Fieldset
      ...
      <div class="col-sm-8 col-md-6">
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <?php endif; if ( !empty($facebook_username) ): ?>
            ...
            <?php endif; if ( !empty($google_plus_username) ): ?>
              <a href="https://plus.google.com/<?php echo $google_plus_username; ?>" class="badge social gplus"
